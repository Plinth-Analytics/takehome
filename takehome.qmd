...
- The data you are analysing are simulated (you'll see details in the documentation), but act as if they are real when you are writing your report.
- When you are finished, submit all of your work in a GitHub repository (can be public or private).
- Share your repository with nathaniel@plinth.co (my github username is pa-nathaniel).
